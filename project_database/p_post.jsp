...
<form action="content_search.jsp" method="post" accept-charset="Big5">
  ...
  <div class="services">
    ...
    <li id="navlist1" style="color: #eee">個人文章 <span style="font-family: Gill Sans MT Condensed">ˊωˋ</span>
    </ol>
  </div>
...
String query = "SELECT content_header, id FROM content WHERE content_postBy='"+account+"'";
...
id= rs.getInt("id");
%> <li class="list-group-item"><a href="content_show.jsp?id=<%=id%>" style="padding: 2%; margin-top: 3%;  font-family: Calibri , 微軟正黑體; font-size: 18px; color: #282828"><%=content_header%> &nbsp&nbsp&nbsp by <%=account%></a></li><br><%

}
}
else{
  %><h5 align="center" style="padding: 10%;"><%out.println("您還沒發過文章哦 !");%></h5><%
}
%></ul></div><%
stmt.close(); 
con.close(); 

...
<form action="content_search.jsp" method="post" accept-charset="Big5">
  ...
  <div class="services">
    ...
    <li id="navlist1" style="color: #eee">所有文章 <span style="font-family: Gill Sans MT Condensed">ˊωˋ</span>
    </ol>
  </div>
...
String query = "SELECT content_header,content_postBy, id FROM content";
